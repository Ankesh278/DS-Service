...
class JobOtp extends StatefulWidget {
  final String phoneNumber;

  const JobOtp({super.key, required this.phoneNumber});

  @override
  JobOtpState createState() => JobOtpState();
}

class JobOtpState extends State<JobOtp> with CodeAutoFill {
